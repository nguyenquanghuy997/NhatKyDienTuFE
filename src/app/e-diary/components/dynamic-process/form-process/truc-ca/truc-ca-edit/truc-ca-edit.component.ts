...
@Component({
  selector: 'app-truc-ca-edit',
  templateUrl: './truc-ca-edit.component.html',
  styleUrls: ['./truc-ca-edit.component.css'],
})
export class TrucCaEditComponent {
  ...
  getJsonSearch() {
    if (document.querySelector('#myFrame')) {
      ...
      if (this.item.StartDTG) {
        /*
         * .utcOffset('+'): Đây là một phương thức của Moment.js để đặt độ chênh lệch thời gian UTC.
        hoặc https://stackoverflow.com/questions/32878197/updating-time-offset-with-moment-utcoffset
         */
