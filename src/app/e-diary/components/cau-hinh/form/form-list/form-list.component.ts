...
export class FormListComponent {
  ...
  addForm() {
    return '/configs/formOld/them-form-mau';
  }
  editForm(id: number) {
    return '/configs/formOld/cap-nhat-form/' + id;
  }

  detailForm(id: number) {
    return '/configs/formOld/chi-tiet-form/' + id;
  }
  ...
  public onDelete(id: number, model: formMauModel) {
    ...
    this.formMauService.deleteSysForm(itemDel).subscribe(
      (result: ResponseModel) => {
